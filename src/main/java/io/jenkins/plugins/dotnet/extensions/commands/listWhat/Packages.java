...
public class Packages extends ListWhat {
  ...
  public void addCommandLineArguments(@NonNull DotNetArguments arguments) throws AbortException {
    ...
    arguments.addFlag("deprecated", this.deprecated);
    arguments.addFlag("outdated", this.outdated);
    arguments.addFlag("vulnerable", this.vulnerable);
    arguments.addOptions("framework", this.frameworks);
    arguments.addFlag("include-transitive", this.includeTransitive);
    arguments.addOption('v', this.verbosity);
    if (this.outdated) {
      arguments.addFlag("include-prerelease", this.includePrerelease);
      arguments.addFlag("highest-minor", this.highestMinor);
      arguments.addFlag("highest-patch", this.highestPatch);
    }
    if (this.deprecated || this.outdated || this.vulnerable) {
      arguments.addOption("config", this.config);
      arguments.addOptions("source", this.sources);
    }
  }
  ...
  @Extension
  @Symbol("packages")
  public static final class DescriptorImpl extends ListWhatDescriptor implements CustomDescribableModel {
    ...
    public UninstantiatedDescribable customUninstantiate(@NonNull UninstantiatedDescribable ud) {
      ...
      for (final Map.Entry<String, ?> arg : oldArgs.entrySet()) {
        ...
        if ("framework".equals(name) || "frameworksString".equals(name)) {
          continue;
        }
        if ("source".equals(name) || "sourcesString".equals(name)) {
          continue;
        }
    ...
    public FormValidation doCheckConfig(@CheckForNull @QueryParameter String value, @QueryParameter boolean deprecated,
      ...
      if (Util.fixEmptyAndTrim(value) != null && !deprecated && !outdated) {
        return FormValidation.warning(Messages.List_Package_OnlyForPackageUpdateSearch());
      }
    ...
    public FormValidation doCheckDeprecated(@QueryParameter boolean deprecated, @QueryParameter boolean outdated,
      ...
      if (deprecated && outdated) {
        return FormValidation.error(Messages.List_Package_EitherDeprecatedOrOutdated());
      }
      return FormValidation.ok();
    }
    ...
    public String getDisplayName() {
      return Messages.List_Package_DisplayName();
    }

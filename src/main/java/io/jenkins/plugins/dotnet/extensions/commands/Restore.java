...
public final class Restore extends Command {
   ...
   */
  @Override
  public void addCommandLineArguments(@NonNull DotNetArguments args) {
    args.add("restore");
  ...
  @Extension
  @Symbol("restore")
  public static final class DescriptorImpl extends CommandDescriptor implements CustomDescribableModel {
